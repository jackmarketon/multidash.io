> This has been modified from Jesse Squires'[great contribe doc](https://github.com/jessesquires/HowToContribute/blob/master/README.md)
...
Style and adherence to conventions is just as important as the code you write. Most of our time is spent reading code, not writing it. *Don't be sloppy. There is a reason we use a linter and a linting file!*

Above all, conform to the existing style of the code in which you are working. When in doubt, refer to the guides below.

## JS style

This project uses a tighter eslint config which itself is based on AirBnB's JS standards.

1. [Project eslint config](/.eslintrc)
2. [AirBnB's JS Standards & Style Guide](https://github.com/airbnb/javascript)
